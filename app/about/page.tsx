      ...
      <main className="flex-grow">
        ...
        <section className="py-20 px-4 bg-slate-50 border-b border-amber-600/10">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-gradient-to-br from-sky-600/10 to-sky-500/5 border border-sky-600/20 rounded-lg p-10 mb-10">
              <p className="text-xl text-slate-900 mb-6 leading-relaxed font-light">
                <span className="text-sky-600 font-semibold">frenaphok LLP End Solutions</span> — We provide solutions where there seems to be none.
              </p>
              ...
              <div>
                ...
                <ul className="space-y-4 text-slate-700">
                  <li className="flex gap-3">
                    <span className="text-sky-600 font-light text-xl">•</span>
        ...
        <section className="py-20 px-4 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="p-8 border border-sky-600/10 bg-white hover:shadow-lg hover:border-sky-600/20 transition-all duration-300 group">
